...
export class CompanyService {
  ...
  getAllCompanies(page: number, pageSize: number, searchQuery: string) {
    return this._http.get<ICompany[]>(`${this.baseURL}/jobseeker/companies?page=${page}&pageSize=${pageSize}&searchQuery=${searchQuery}`)
  }
